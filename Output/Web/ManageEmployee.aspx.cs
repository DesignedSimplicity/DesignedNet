...
{
	/// <summary>User interface class for managment of Employee entities</summary>
	/// ================================================================================
	/// Object:	    Storage.Framework.Web.ManageEmployee
	/// Language:	C# ASP.NET 
	/// --------------------------------------------------------------------------------
	/// Author:	    KHutchens
	/// Created:	08.12.03
	...
	/// ================================================================================
	public class ManageEmployee : System.Web.UI.Page, DesignedNet.Framework.Web.IWebPage
	{
		//========================================================
		...
		protected Storage.Framework.Web.Controls.EmployeeView view;
		protected Storage.Framework.Web.Controls.EmployeeEdit edit;
		protected Storage.Framework.Web.Controls.EmployeeList list;
		protected int _selectedEmployeeID;
		protected BizEmployee _employeeList;
		protected BizEmployee _employee;
		...
		public void Render(Common.PageMode pageMode, string message)
		{
			...
			switch (pageMode)
			{
				...
				case Common.PageMode.New :
					...
					urlCancel.NavigateUrl = "ManageEmployee.aspx";
				...
				case Common.PageMode.Edit :
					...
					urlCancel.NavigateUrl = "ManageEmployee.aspx?EmployeeID=" + _selectedEmployeeID.ToString();
					urlCancel.Visible = true;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			_selectedEmployeeID = DesignedNet.Framework.Web.Common.GetID(Request.QueryString, "EmployeeID");
			if (_selectedEmployeeID < 1) _selectedEmployeeID = DesignedNet.Framework.Web.Common.GetID(ViewState, "EmployeeID");

			// populate list control
			_employeeList = new BizEmployee();
			_employeeList.List();
			list.DataSource = _employeeList;

			// decide page mode
			_employee = new BizEmployee();
			_employee.Table = _employeeList.Table;
			if (_selectedEmployeeID > 0)
			{
				// load selected
				if (_employee.Find(_selectedEmployeeID))
				{
					edit.DataSource = _employee;
					view.DataSource = _employee;
		...
		public void cmdCreate_Click(object sender, System.EventArgs e)
		{
			...
			{
				_employee.Save();
				ViewState["EmployeeID"] = _employee.EmployeeID;
				Render(Common.PageMode.Edit, "Created Employee #" + _employee._employeeID.ToString() + " @ " + DateTime.Now);
			}
		...
		public void cmdUpdate_Click(object sender, System.EventArgs e)
		{
			...
			{
				_employee.Save(); // save
				Render(Common.PageMode.Edit, "Updated Employee #" + _employee._employeeID.ToString() + " @ " + DateTime.Now);
			}
			else // show error message
				lblMsg.Text = msg;
		}
		...
		public void cmdSearch_Click(object sender, System.EventArgs e)
		{
			...
			{
				_employeeList.Filter("Employee", txtSearch.Text);
		...
		{
			// process delete
			if (_employee.Delete() && _employee.Save())
