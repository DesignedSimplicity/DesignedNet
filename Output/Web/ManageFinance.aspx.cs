...
{
	/// <summary>User interface class for managment of Finance entities</summary>
	/// ================================================================================
	/// Object:	    Storage.Framework.Web.ManageFinance
	/// Language:	C# ASP.NET 
	/// --------------------------------------------------------------------------------
	/// Author:	    KHutchens
	/// Created:	08.12.03
	...
	/// ================================================================================
	public class ManageFinance : System.Web.UI.Page, DesignedNet.Framework.Web.IWebPage
	{
		//========================================================
		...
		protected Storage.Framework.Web.Controls.FinanceView view;
		protected Storage.Framework.Web.Controls.FinanceEdit edit;
		protected Storage.Framework.Web.Controls.FinanceList list;
		protected int _selectedFinanceID;
		protected BizFinance _financeList;
		protected BizFinance _finance;
		...
		public void Render(Common.PageMode pageMode, string message)
		{
			...
			switch (pageMode)
			{
				...
				case Common.PageMode.New :
					...
					urlCancel.NavigateUrl = "ManageFinance.aspx";
				...
				case Common.PageMode.Edit :
					...
					urlCancel.NavigateUrl = "ManageFinance.aspx?FinanceID=" + _selectedFinanceID.ToString();
					urlCancel.Visible = true;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			_selectedFinanceID = DesignedNet.Framework.Web.Common.GetID(Request.QueryString, "FinanceID");
			if (_selectedFinanceID < 1) _selectedFinanceID = DesignedNet.Framework.Web.Common.GetID(ViewState, "FinanceID");

			// populate list control
			_financeList = new BizFinance();
			_financeList.List();
			list.DataSource = _financeList;

			// decide page mode
			_finance = new BizFinance();
			_finance.Table = _financeList.Table;
			if (_selectedFinanceID > 0)
			{
				// load selected
				if (_finance.Find(_selectedFinanceID))
				{
					edit.DataSource = _finance;
					view.DataSource = _finance;
		...
		public void cmdCreate_Click(object sender, System.EventArgs e)
		{
			...
			{
				_finance.Save();
				ViewState["FinanceID"] = _finance.FinanceID;
				Render(Common.PageMode.Edit, "Created Finance #" + _finance._financeID.ToString() + " @ " + DateTime.Now);
			}
		...
		public void cmdUpdate_Click(object sender, System.EventArgs e)
		{
			...
			{
				_finance.Save(); // save
				Render(Common.PageMode.Edit, "Updated Finance #" + _finance._financeID.ToString() + " @ " + DateTime.Now);
			}
			else // show error message
				lblMsg.Text = msg;
		}
		...
		public void cmdSearch_Click(object sender, System.EventArgs e)
		{
			...
			{
				_financeList.Filter("Finance", txtSearch.Text);
		...
		{
			// process delete
			if (_finance.Delete() && _finance.Save())
